...
def buy_item(item_name):
    ...
    # If user already bought the item don't let them to buy again. But they can buy the health potion even if they have it already
    ...
    if player["gold"] >= item["price"]:
        ...
        if "health" in item:
            ...
            slow_print(f"✅ You bought a {item_name}! It will help you defeat enemies faster.")
    else:
...
def explore():
    ...
    if encounter == "enemy":
        ...
        slow_print("🤷‍♂️ You explore for a while but find nothing interesting.")
...
def enemy_encounter():
    ...
    while enemy_health > 0 and player["health"] > 0:
        ...
        if choice == "1" or "attack" in choice:
            ...
            slow_print(f"😱 The {enemy['name']} attacks you for {enemy['damage']} damage!")
            ...
            if "health potion" in player["items"]:
                ...
                player['health'] = min(player['health'] + items["health potion"]["health"], 100)
                slow_print(f"🧪 You used a health potion and restored {items['health potion']['health']} health")
            else:
            ...
            if random.random() > 0.5:
                slow_print("🏃‍♂️ You managed to escape!")
                return
            else:
