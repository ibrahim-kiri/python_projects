...
title_label = tk.Label(window, text="Simple Drawing App", font=("Helvetica", 16))
...
canvas.bind("<Button-1>", start_position) # this records the starting coordinates for drawing
canvas.bind("<B1-Motion>", draw_line) # this tracks movement and draws lines

instruction_label = tk.Label(window, text="Click and drag to draw", font=("Helvetica", 10))
